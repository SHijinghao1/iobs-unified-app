...
export const BottomBar: React.FC = () => {
  ...
  return (
    <div className="h-10 w-full bg-deep-space/95 border-t border-gray-800 flex items-center px-4 relative z-50 backdrop-blur-md overflow-hidden">
      {/* Voice Command Feedback (Pad 系统增强) */}
      <div className="flex items-center shrink-0 border-r border-gray-800 pr-4 mr-4 gap-2">
        <div className="w-2.5 h-2.5 rounded-full bg-neon-green animate-pulse shadow-[0_0_8px_#00FF88]" />
        <span className="text-[10px] text-gray-500 font-bold tracking-widest">VOICE</span>
        <span className="text-sm text-neon-cyan font-mono font-bold tracking-tight">&quot;Bed, height 98&quot;</span>
        <CheckCircle size={16} className="text-neon-green ml-1" />
      </div>
