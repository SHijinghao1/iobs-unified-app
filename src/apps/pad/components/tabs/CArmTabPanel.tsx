      ...
      <div className="w-full rounded-xl border border-gray-800 bg-gray-950/70 p-1.5">
        <div className="grid w-full grid-cols-3 gap-1.5">
          <button
            ...
            disabled={disabled}
            className="h-9 w-full rounded-lg border border-purple-500/70 bg-purple-400/20 px-3 text-[12px] font-bold text-purple-100 hover:border-purple-300 hover:bg-purple-400/30 disabled:opacity-50 select-none"
          >
            上升
          </button>
          <button
